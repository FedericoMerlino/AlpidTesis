...
namespace Alpid.Data.Migrations
{
    ...
    [Migration("20190708211753_[crear1]")]
    partial class crear1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alpid.Models.ProductoTipos", b =>
                {
                    b.Property<int>("PoductosTipoID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Alpid.Models.Productos", b =>
                {
                    ...
                    b.Property<int?>("ProductoTiposPoductosTipoID");

                    b.Property<int>("ProductosTipoID");

                    b.Property<int>("ProveedoresID");

                    b.HasKey("PoductosID");

                    b.HasIndex("ProductoTiposPoductosTipoID");
            ...
            modelBuilder.Entity("Alpid.Models.Productos", b =>
                {
                    b.HasOne("Alpid.Models.ProductoTipos", "ProductoTipos")
                        .WithMany("Productos")
                        .HasForeignKey("ProductoTiposPoductosTipoID");
